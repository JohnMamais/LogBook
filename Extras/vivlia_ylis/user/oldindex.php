...
<head>
    ...
    <script>sessionStorage.setItem("username", "john_doe");</script> <!--for testing purposes-->
</head>
<body>
    ...
    <script>
        //getting the username and transfering it from javascript to php through cookies
        var usernameIni = sessionStorage.getItem('username');
        document.cookie = `username = ${usernameIni}`;
    </script>
    <?php
